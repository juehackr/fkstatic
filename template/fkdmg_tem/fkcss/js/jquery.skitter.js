	...
	$sk.fn.extend({
				...
				if (self.settings.thumbs) {
					...
					self.box_skitter.find('.info_slide').append(
						'<span class="image_number'+initial_select_class+'" rel="'+(u - 1)+'" id="image_n_'+u+'_'+self.number_skitter+'">'
							+'<img data-original="'+src+'" '+dimension_thumb+' />'
							+'</span> '
					);
				}
				else {
		...
		getBoxClone: function()
		{
			if (this.settings.link_atual != '#') {
				var img_clone = $('<a href="'+this.settings.link_atual+'"><img data-original="'+this.settings.image_atual+'" /></a>');
			} 
			else {
				var img_clone = $('<img data-original="'+this.settings.image_atual+'" />');
			}
		...
		{
			if (this.settings.link_atual != '#') {
				var img_clone = $('<a href="'+this.settings.link_atual+'"><img data-original="'+image_old+'" /></a>');
			} 
			else {
				var img_clone = $('<img data-original="'+image_old+'" />');
			}
